...
const routes: Routes = [
  {
    ...
    children: [
    //  {path:'radian', loadChildren: () => RadianModule},
    //  {path:'event', loadChildren: () =>EventModule},
    //  {path:'portfolio', loadChildren: () => PortfolioModule},
    //  {path:'setting', loadChildren: () =>SettingsModule}
      {path:'radian_view', component:RdRadianListComponent},
      {path:'radian_add', component:RdRadianAddComponent},
      {path:'radian_edit/:id', component:RdRadianEditComponent},
      {
        path:'portfolio_view',
